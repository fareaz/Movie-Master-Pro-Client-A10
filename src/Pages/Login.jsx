        ...
        <form onSubmit={handleLogIn}>
          <fieldset className="fieldset ">
            ...
            <input
              ...
              name="email"
              autoComplete="email"
              className="input text-gray-200 rounded-lg border border-red-400 bg-transparent px-3 py-2 outline-none focus:ring-2 focus:ring-red-500 placeholder-gray-400"
              ref={emailRef}
              placeholder="Email"
              required
            />
            ...
            <div className="relative">
              <input
                ...
                className="input text-gray-200 rounded-lg border border-red-400 bg-transparent px-3 py-2 outline-none focus:ring-2 focus:ring-red-500 placeholder-gray-400 w-full"
