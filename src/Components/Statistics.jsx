...
const Statistics = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center  p-8">
      <h1 className="text-3xl font-bold mb-8">Platform <span className='text-red-500 '>Statistics</span></h1>
...
>
  ...
  <p className="text-4xl font-bold text-gray-800 dark:text-white">{stats.totalMovies}</p>
</motion.div>
