...
const Hero = () => {
  ...
  if (!movies.length)
    return <div className="w-full py-10 text-center">No movies found.</div>;
      ...
      <div className="relative">
        ...
        <div className="absolute inset-y-1/2 left-3 transform -translate-y-1/2">
          <button
            aria-label="Previous"
            onClick={prev}
            className="w-10 h-10 rounded-full bg-white/20 text-white flex items-center justify-center shadow-lg hover:scale-105 transition"
          >
            ◀
          </button>
        </div>
